        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {selectedProposals.map((proposal) => (
            <Card key={proposal.id}>
              <CardHeader>
                <CardTitle>{proposal.proposal.subcontractor.enterprise_name}</CardTitle>
              </CardHeader>
              <CardContent>
                <p><strong>Propuesta Técnica:</strong> {proposal.proposal.tecnical_proposal}</p>
                <p><strong>Propuesta Económica:</strong> {proposal.proposal.economic_proposal}</p>
